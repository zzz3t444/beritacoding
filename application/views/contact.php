            ...
            <div class="md:col-span-2 max-w-3xl">
                <form action="" method="post" class="bg-black border border-neutral-800 shadow-lg rounded-3xl p-8">
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="border border-neutral-800 bg-black rounded-md px-4 py-2 w-full <?= form_error('name') ? 'border-red-500' : 'border-gray-300' ?>" placeholder="John Trengelly" value="<?= set_value('name') ?>" required maxlength="32" />
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" class="border border-neutral-800 bg-black rounded-md px-4 py-2 w-full <?= form_error('email') ? 'border-red-500' : 'border-gray-300' ?>" placeholder="hello@jurnagency.com" value="<?= set_value('email') ?>" required />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="message" class="border border-neutral-800 bg-black rounded-md px-4 py-2 w-full <?= form_error('message') ? 'border-red-500' : 'border-gray-300' ?>" rows="5" placeholder="Write your message" required><?= set_value('message') ?></textarea>
